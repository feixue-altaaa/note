...
>
> [异步传输](https://www.zhihu.com/search?q=异步传输&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"answer"%2C"sourceId"%3A24708736})+js+xml。
>
...
>
> （虽然提供[异步通讯](https://www.zhihu.com/search?q=异步通讯&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"answer"%2C"sourceId"%3A24708736})功能的组件默认情况下都是异步的，但它们也提供了同步选项，如果你好奇把那个选项改为false的话，你的页面就会死在那里）
>
> xml只是一种数据格式，在这件事里并不重要，我们在更新一行字的时候理论上说不需要这个格式，但如果我们更新很多内容，那么格式化的数据可以使我们有条理地去实现更新。
>
> 现在大部分人其实是用JSON这种格式来代替XML的，因为前者更加简洁，据说目前的[解析速度](https://www.zhihu.com/search?q=解析速度&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"answer"%2C"sourceId"%3A24708736})也更快。多快好省，能省则省啊。
>
> **总结：只要是JS调用[异步通讯组件](https://www.zhihu.com/search?q=异步通讯组件&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"answer"%2C"sourceId"%3A24708736})并使用格式化的数据来更新web页面上的内容或操作过程，那么我们用的方法就可算是AJAX**
...
> 什么是ServletContext
>
> https://www.cnblogs.com/zzvar/p/14921115.html#3__125
>
> ### 概念
>
